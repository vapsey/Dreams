$(document).ready(function () {
    ...
    $('#submit-btn').click(function () {
        ...
        var cityAnswer = $('#cityInput-1').text();
    ...
    var startListening = function () {
        ...
        rootRef.on('child_added', function (person) {
            ...
            var realCityInput = personData.personCity;
            ...
            personBlock += '<div class="e">' + realCityInput + '</div>';
            ...
            //            $('#results').append('<div class="e">' + realCityInput + '</div>')
    ...
    $(".write-city").keypress(function (e) {
        return e.which != 13;
    });
